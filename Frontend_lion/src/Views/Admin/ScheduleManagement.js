            ...
            <div className="collapse navbar-collapse" id="navbarsExample04">
              <ul className="navbar-nav ms-auto mb-2 mb-md-0 justify-content-end">
                <li className="nav-item">
                  <a className="nav-link text-dark color" id="option" href="#">
                    <i className="bi bi-person-circle" id="icono"></i> Perfil
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link text-dark color" id="option" href="../Index.html">
                    ...
                    >
                      <li className="w-100">
                        ...
                        >
                          ...
                          <i className="fs-4 bi bi-plus" id="icono2"></i>
                        </a>
                      </li>
                      <li className="w-100">
                        <a
