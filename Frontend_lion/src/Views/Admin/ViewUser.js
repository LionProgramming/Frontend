        ...
        <div className="container-fluid">
          <div className="row flex-nowrap">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <li className="w-100">
                        ...
                        >
                          {" "}
                          <span className="d-none d-sm-inline" id="active">
            ...
            >
              ...
              <div
                className="table-responsive col-8 col-md-0 col-xl-10 px-sm-1 px-0 mt-4"
                id="tablaRegistros"
              >
                <table
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      <td>{userData.id}</td>
                      <td>
                        {userData.nombre1} {userData.nombre2}
                      </td>
                      <td>{userData.email}</td>
                      <td>{userData.rol_idrol}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
