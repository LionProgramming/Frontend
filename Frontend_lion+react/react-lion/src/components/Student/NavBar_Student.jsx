  ...
  <div className="container-navbar_Student">
    <div className="collapse navbar-collapse">
      ...
      <li className='nav-item'>
        <a className="nav-link text-dark"href="../student-schedule"><i className="bi bi-calendar-event"></i>
        Horario</a>
      </li>
      <li className="nav-item ">
                  <a className="nav-link text-dark" href="../student-observations"><i className="bi bi-book"></i>
                    Observador</a>
                </li>
      <li className="nav-item">
        <a href="/student-index" className="nav-link text-dark" >
