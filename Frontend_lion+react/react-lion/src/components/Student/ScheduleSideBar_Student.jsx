...
function EstudentSidebarSchedule () {
      ...
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <i className= "fs-4 bi-table sb-inactive"></i> 
            <span id='text-sb' className="ms-1 d-none d-sm-inline sb-inactive"> Mis observaciones</span>
          </a>      

            </li>
            <li>
            <a href="/student-schedule" className="nav-link px-0 align-middle">
            <i className="fs-4 bi bi-clock sb-active"></i> 
            <span id='text-sb' className="ms-1 d-none d-sm-inline sb-active"> Mi horario</span>
          </a>
            </li>
          </ul>
...
export default EstudentSidebarSchedule